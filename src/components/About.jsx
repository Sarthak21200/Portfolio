  ...
  return (
    ...
    >
      <div>
        ...
        <div className="font-bold">AEH (Advance Application Engineer) Intern at <span className="text-purple-700 font-bold">Accenture </span>, Gurugram, Haryana (May,24 - July,24)</div>
        </div>
        <div>
          ● Conducted in-depth analysis of code coverage to ensure comprehensive testing of software applications.
          </div>
          <div>
          ● Develop, test, and deploy high-quality web applications using the MERN stack
          </div>
          <div>
● Implemented and optimized testing frameworks to improve code quality and reliability.
        </div>
        </span>
        <br></br>
        <h1 className="text-green-600 font-semibold text-xl">
