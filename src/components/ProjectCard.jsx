...
const Card = ({ image, text1, text2, text3, text4 }) => {
  ...
  return (
    <div
      className="relative w-64 h-80 m-10 bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 ease-in-out transform hover:scale-105 bg-gradient-to-b from-violet-300 to-pink-200"
    ...
    >
      ...
      {!hovered && (
        <>
          ...
          <p className="p-4 text-center text-base font-semibold">{text1}</p>
      ...
      {hovered && (
        <div className="absolute inset-0 flex flex-col justify-center items-center text-center bg-gray-200 bg-opacity-75 backdrop-filter backdrop-blur-lg transition-opacity duration-300 ease-in-out bg-slate-950">
