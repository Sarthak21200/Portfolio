...
function Card({ imageUrl, text1, text2, text3 ,text4}){
  return (
    <div className="max-w-sm w-full sm:w-1/2 md:w-1/3 lg:w-1/4 overflow-hidden shadow-lg hover:shadow-red-700 hover:shadow-xl transform transition duration-500 hover:scale-105 bg-opacity-90 m-4 rounded-3xl">
