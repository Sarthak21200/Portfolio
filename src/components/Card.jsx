  ...
  return (
    <div className="max-w-sm w-full sm:w-1/2 md:w-1/3 lg:w-1/4 overflow-hidden shadow-lg hover:shadow-current hover:shadow-xl transform transition duration-500 hover:scale-105 bg-opacity-90 m-4 rounded-3xl">
      ...
      <div className="px-6 py-5 bg-slate-700">
        <p className="text-amber-500 text-lg font-semibold mb-2">{text1}</p>
        <p className="text-amber-400 text-base mb-2">{text2}</p>
        <p className="text-amber-400 text-base mb-2">{text3}</p>
        <p className="text-amber-400 text-base mb-2">{text4}</p>
      </div>
    </div>
  );
};
